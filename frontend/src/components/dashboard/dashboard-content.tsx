...
const dashboardTourSteps: Step[] = [
  {
    ...
    content: 'Type your questions or tasks here. Iris can help with research, analysis, automation, and much more.',
...
export function DashboardContent() {
  ...
  return (
    <>
      ...
      {/* Tour confirmation dialog temporarily hidden */}
          ...
          <div className="min-h-full flex flex-col">
            {(
              <div className="flex justify-center px-4 pt-4 md:pt-8">
                {/* Release badge temporarily hidden */}
            ...
            {/* Sample prompts temporarily hidden */}
            ...
            {/* Custom agents section temporarily hidden */}
            {/* {enabledEnvironment && (
