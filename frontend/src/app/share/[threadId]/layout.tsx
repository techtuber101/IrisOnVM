...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Iris',
    description: 'Replay this Agent conversation on Iris',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Iris';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Iris';
